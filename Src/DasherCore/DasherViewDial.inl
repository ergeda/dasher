...
namespace Dasher {
  ...
  inline myint CDasherViewDial::ixmap(myint x) const
  {
    x -= iMarginWidth;
  ...
  inline myint CDasherViewDial::xmap(myint x) const
  {
  ...
  inline myint CDasherViewDial::ymap(myint y) const {
  ...
  inline myint CDasherViewDial::iymap(myint ydash) const {
    if (GetBoolParameter(BP_NONLINEAR_Y)) {
      if(ydash > m_Y2)
